...
- **[LangGraph Studio](https://studio.langchain.com/)** - Visual IDE for building and debugging stateful agent workflows (2026)
  - [Documentation](https://langchain-ai.github.io/langgraph/tutorials/langgraph-studio/) | [Download](https://studio.langchain.com/)
- **[AutoGen Studio 2.0](https://autogen-studio.com/)** - Next-gen visual interface for multi-agent conversations (2026)
...
- **[Weights & Biases](https://wandb.ai/)** - Enhanced experiment tracking and monitoring for AI agents (v0.19+)
...
- **[LangFuse](https://langfuse.com/)** - Open-source observability & analytics for LLM applications (v3.5+)
  - [GitHub](https://github.com/langfuse/langfuse) | [Documentation](https://langfuse.com/docs)
- **[Helicone](https://www.helicone.ai/)** - Observability platform for LLM applications with cost tracking (2026)
  - [GitHub](https://github.com/Helicone/helicone) | [Documentation](https://docs.helicone.ai/)
- **[Cursor](https://cursor.sh/)** - AI-first code editor with advanced agent integration (v0.45+)
  - [Agent Development Templates](https://cursor.sh/features) | [Extensions](https://cursor.sh/docs)
- **[GitHub Copilot](https://github.com/features/copilot)** - Multi-model AI coding assistant with workspace context (2026)
...
- **[Windsurf](https://codeium.com/windsurf)** - AI-first IDE with cascade mode and agentic flows (2026)
  - [Features](https://codeium.com/windsurf/features) | [Documentation](https://codeium.com/windsurf/docs)
- **[v0.dev](https://v0.dev/)** - Vercel's AI agent for generating UI components and applications (2026)
  - [Examples](https://v0.dev/examples) | [Documentation](https://v0.dev/docs)
- **[Bolt.new](https://bolt.new/)** - AI-powered full-stack web development agent by StackBlitz (2026)
  - [Features](https://bolt.new/features) | [Templates](https://bolt.new/templates)
- **[Continue.dev](https://continue.dev/)** - Open-source AI coding assistant with custom model support (2026)
  - [GitHub](https://github.com/continuedev/continue) | [Documentation](https://docs.continue.dev/)
- **[Aider](https://aider.chat/)** - AI pair programming in terminal with repository awareness (v0.65+)
  - [GitHub](https://github.com/paul-gauthier/aider) | [Documentation](https://aider.chat/docs/)
- **[Replit Agent](https://replit.com/ai)** - AI agent for complete application development in browser (2026)
  - [Features](https://replit.com/ai) | [Documentation](https://docs.replit.com/ai)
- **[Braintrust](https://www.braintrustdata.com/)** - AI product development platform with evals and logging (2026)
  - [GitHub](https://github.com/braintrustdata/braintrust) | [Documentation](https://www.braintrustdata.com/docs)
- **[Agenta](https://agenta.ai/)** - Open-source LLM development platform with prompt management (2026)
...
- **[AgentOps](https://www.agentops.ai/)** - Observability and analytics platform for AI agents (2026)
  - [GitHub](https://github.com/AgentOps-AI/agentops) | [Documentation](https://docs.agentops.ai/)
- **[LangTest](https://github.com/JohnSnowLabs/langtest)** - Comprehensive testing suite for LLM applications (2026)
...
- **[Chainlit](https://chainlit.io/)** - Build conversational AI interfaces (2026)
  - [GitHub](https://github.com/Chainlit/chainlit) | [Documentation](https://docs.chainlit.io/)
- **[LangWatch](https://langwatch.ai/)** - LLM monitoring and analytics platform (2026)
  - [GitHub](https://github.com/langwatch/langwatch) | [Documentation](https://docs.langwatch.ai/)
- **[Humanloop](https://humanloop.com/)** - LLM application development platform (2026)
